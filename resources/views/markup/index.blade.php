<x-app-layout>
    ...
    <div class="mt-4 text-center text-2xl text-indigo-600 font-extrabold">Markup Rates</div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        @foreach($clients as $client)
                            <tr class="{{$loop->iteration % 2 == 0 ? 'bg-white' : 'bg-gray-100'}} ">
                                ...
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{ isset($client->currentMarkupRate) ? $client->currentMarkupRate->markup : ''}}%</td>
                                <td class="whitespace-nowrap text-right py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                                    <a class="p-1 text-xs bg-blue-300 rounded hover:bg-blue-100" href="{{route('markup.edit', $client->id)}}">Update</a>
                                </td>
                            </tr>
                        @endforeach
