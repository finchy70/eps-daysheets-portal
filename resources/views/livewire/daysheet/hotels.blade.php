                ...
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        @foreach($daysheet->hotels as $hotel)
                            <tr>
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">{{$hotel->name}}</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{$hotel->quantity}}</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{$hotel->cost_per_unit}}</td>
                    ...
                    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 mx-auto max-w-xl">
                        <div class="transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all w-full">
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-2">
                                ...
                                <div class="sm:col-span-2 sm:mt-0">
                                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input wire:model="quantity" type="number" step="1" name="quantity" id="quantity" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value="">
                                    </div>
