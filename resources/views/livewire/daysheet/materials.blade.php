    ...
    <div class="px-8 py-4 bg-gray-200 border border-indigo-500 rounded-xl">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Edit Materials / Consumables.</h1>
                <p class="mt-2 text-sm text-gray-700">A list of all the materials and consumables allocated to this daysheet.</p>
            </div>
            ...
            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead>
                        <tr>
                            <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">Materials / Consumables</th>
