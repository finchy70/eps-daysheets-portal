                        ...
                        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-300">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="py-1 bg-gray-600 px-3 text-left text-sm font-semibold text-gray-100">Published</th>
                                ...
                                @foreach($daysheets as $daysheet)
                                    <tr class="{{$loop->iteration % 2 == 0 ? 'bg-white' : 'bg-gray-100'}} ">
                                        ...
                                        <td class="row flex justify-end space-x-4 py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
