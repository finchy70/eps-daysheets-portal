    ...
    <div>
        ...
        <form action="{{route('roles.store')}}" method="POST">
            ...
            <div class="mt-8 max-w-2xl mx-auto border border-indigo-500 rounded-lg p-4 bg-white">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <input type="number" step="0.01" name="rate"  class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{old('rate')}}"/>
                </div>
